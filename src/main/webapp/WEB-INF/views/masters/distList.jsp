									...
									<c:forEach items="${distList}" var="distList" varStatus="count">
										<tr>
											...
											<td align="left"><c:if test="${langSelected == 0}">
													...
													<c:out value="${distList.distMarName}" />
											...
											<td align="left"><c:if test="${langSelected == 0}">
													...
													<c:out value="${distList.distAddMar}" />
											...
											<td>
												<div class="fa-hover col-lg-3 col-md-6">
													<a
														href="${pageContext.request.contextPath}/editDist/${distList.distId}"><i
														class="fa fa-edit"></i> <span class="text-muted"></span></a>
												</div>

												<div class="fa-hover col-lg-3 col-md-6">
													<a
														href="${pageContext.request.contextPath}/deleteDist/${distList.distId}"
